...
<img src="assets/IO-DMA.png" style="zoom: 50%;" />
...
![](assets/IO-BIO工作流程.png)

read 调用图示：read、write 都是系统调用指令

<img src="assets/IO-缓冲区读写.png" style="zoom: 67%;" />
...
<img src="assets/三次握手.png" alt="三次握手" style="zoom: 50%;" />
...
* 常用 API：`public Socket accept()`，**阻塞等待**接收一个客户端的 Socket 管道连接请求，连接成功返回一个 Socket 对象
  ...
  <img src="assets/Netty-TCP三次握手.png" style="zoom:67%;" />
...
* 位置、限制、容量遵守以下不变式： **0 <= position <= limit <= capacity**
  ...
  <img src="assets/NIO-Buffer操作.png" style="zoom:67%;" />
...
<img src="assets/JVM-直接内存直接缓冲区.png" style="zoom: 50%;" />

<img src="assets/JVM-直接内存非直接缓冲区.png" style="zoom:50%;" />
